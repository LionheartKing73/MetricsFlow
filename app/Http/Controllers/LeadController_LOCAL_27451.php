...
class LeadController extends Controller
{
    ...
    public function showLeads(){
        $sessions = Leads::where('client_id', '004')->distinct('e_id')->groupBy('e_id')->take(60)->get();
        ...
        $channels = Channels::where('client_id', '004')->orderBy('Value', 'DESC')->take(3)->get();
        $chan_sum = Channels::where('client_id', '004')->sum('Value');
